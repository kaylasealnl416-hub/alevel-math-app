export const T = {
  en: {
    logoTitle: "Pearson Edexcel A Levels", logoSub: "A Level Learning Platform", langBtn: "English",
    nav: { curriculum: "📚 Curriculum", quiz: "✍️ Quiz", exam: "🎯 Exam", mock: "📋 Mock Exam", errorbook: "📕 Error Book" },
    heroTag: "Pearson Edexcel International A Level",
    ...
    mockDesc: "Realistic mock exams based on Pearson Edexcel IAL papers. Full exam timing, AI-powered marking, and detailed feedback.",
    ...
    examPaperTitle: "Pearson Edexcel International A Level",
