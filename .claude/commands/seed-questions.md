---
description: 触发 question-seeder skill 出题。用法：/seed-questions <chapter_id> <题数> [难度] —— 例：/seed-questions math_p1c3 5 4
---
...
参数解析（位置参数）：
1. **chapter_id 或学科/单元名**（必填）：如 `math_p1c3` / `e1c2` / `P1` / `Unit1` / `WMA11` / `mathematics`
2. **题数**（必填）：每章节题数
...
- `/seed-questions math_p1c3 5 4` → 给联立方程章出 5 道难度 4 的题
